#Reese Kinkade
 #The integration project that I made is a puzzle story game that asks questions to solve the puzzles/riddles.
#The website I used to help: https://www.studytonight.com/post/the-sep-and-end-parameters-in-python-print-statement#:~:text=The%20end%20parameter%20The%20end%20parameter%20is%20used,specify%20the%20parameter%20end%20as%20%27%20%20%27. 
print("Welcome to my integration project!")
import sys
# The import sys makes it so that I can call upon system exit, so if the player decides not play they can leave the program
def main():
...
print("9")              
answer8=input("Good wow you have sucessfully have completed the first part of test! Only 80% of people continue to the second test, but you will fail the next, how do you feel?")
